...
jQuery(window).load(function() {
    ...
    $('.gnet-waypoint').css('marginTop', $('.gnet-header').outerHeight(true) );
}
});

// Fixed Header
// ======================
var $head = $( '#gnet-header' );
jQuery( '.gnet-waypoint' ).each( function(i) {
    var $el = $( this ),
    ...
    $el.waypoint( function( direction ) {
        if( direction === 'down' && animClassDown ) {
            $head.attr('class', 'gnet-header ' + animClassDown);
        }
        else if( direction === 'up' && animClassUp ){
            $head.attr('class', 'gnet-header ' + animClassUp);
        }
    }, { offset: '-1px' } );
} );
...
var $head2 = $( '#gnet-header2' );
jQuery( '.gnet-waypoint2' ).each( function(i) {
    var $el = $( this ),
        animClassDown = $el.data( 'animateDown' ),
        animClassUp = $el.data( 'animateUp' );
    ...
    $el.waypoint( function( direction ) {
        if( direction === 'down' && animClassDown ) {
            $head2.attr('class', 'gnet-header2 ' + animClassDown);
        }
        else if( direction === 'up' && animClassUp ){
            $head2.attr('class', 'gnet-header2 ' + animClassUp);
        }
...
// ======================
jQuery(window).load(function() {
if( jQuery('body').find('#carouselproducts').length>0 ) {
    jQuery("#carouselproducts").carouFredSel({
            responsive: true,
            scroll: 1,
            auto: true,
            items: {
            ...
            prev    : { 
                button  : ".carousel1-container .prev",
                key     : "left"
            },
            next    : { 
                button  : ".carousel1-container .next",
                key     : "right"
            }
...
// ======================
jQuery(window).load(function() {
if( jQuery('body').find('#carouselrecent').length>0 ) {
    jQuery("#carouselrecent").carouFredSel({
            responsive: true,
            scroll: 1,
            auto: true,
            items: {
